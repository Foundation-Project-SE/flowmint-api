...
# 2: Provide Alembic "blueprints" for tables (MetaData)
target_metadata = Base.metadata

# 3: Overwrite alembic.ini URL with .env URL.
# No password storage on configuration files.
# safe_url escapes '%' symbols from password in order to configparser works correctly
...
async def run_async_migrations() -> None:
    ...
    # Temporary engine just for the migration
